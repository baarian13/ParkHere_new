...
public class ServerUserFunctionalityTest {
    ...
    public void search() throws Exception {
        ...
        List<SpotDAO> spots = ServerConnector.search("707 West 28th Street, Los Angeles, CA 90007");
    ...
    public void signup() throws Exception {
        int result = ServerConnector.signup("rjason14@gmail.com", "jerome", "Jason", "Roodman", "3147911267", 1, 1, null);
