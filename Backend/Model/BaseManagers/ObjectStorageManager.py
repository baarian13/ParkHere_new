...
class ObjectStorageManager(object):
    ...
    def uploadMedia(self, path, contentAsString):
        ...
        contentAsString = base64.urlsafe_b64decode(contentAsString.encode("ascii"))
        while len(contentAsString) % 4 != 0:
            contentAsString += "="
        k.set_contents_from_string(contentAsString)
    ...
    def downloadPictureAsB64(self, path):
        ...
        :type paths: str
        '''
        return base64.urlsafe_b64encode(self.downloadPictureAsString(path))
